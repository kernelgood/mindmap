...
#Холст
canv = Canvas(frame, bg="white", width=1600, height=800, scrollregion=scrollregion)
#Полоса прокрутки
xscroll = Scrollbar(frame, orient='horizontal', command=canv.xview)
canv.configure(xscrollcommand=xscroll.set)
xscroll.pack(side=BOTTOM, fill=X)
yscroll = Scrollbar(frame, orient='vertical', command=canv.yview)
...
def save_image():
	...
	hen = filedialog.asksaveasfilename(defaultextension = '.png')
...
am.add_command(label="Сохранить как рисунок", command=save_image)
#О программе
